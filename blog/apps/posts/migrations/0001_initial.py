# Generated by Django 5.1.5 on 2025-08-06 03:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='sub_category_posts', to='category.category')),
                ('topic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='topic_posts', to='category.category')),
            ],
            options={
                'ordering': ('created_at',),
            },
